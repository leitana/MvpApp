...
import com.lx.mvpapp.viewimpl.film.FilmLiveFragment;
import com.lx.mvpapp.viewimpl.film.FilmTop250Fragment;
...
public class BookFragment extends BaseFragment {
    ...
    public static BookFragment newInstance() {
        BookFragment filmFragment = new BookFragment();
        return filmFragment;
    }

    private void initView(){
        mTitles = getResources().getStringArray(R.array.tab_book);

        fragmentList = new ArrayList<>();
        for (int i= 0; i < mTitles.length; i++) {
            fragmentList.add(BookReadFragment.newInstance(i, mTitles[i]));
        }
