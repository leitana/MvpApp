...
public class RetrofitServer {
    ...
    private static File cacheFile = new File(MyApplication.getContext().getCacheDir(),
            "HttpCache"); // 指定缓存路径
...
//                        .addHeader("Content-Type", "application/json")
    ...
    private static OkHttpClient mOkHttpClient = new OkHttpClient.Builder().cache(cache)
