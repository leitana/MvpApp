...
public abstract class BaseRecyclerPoAdapter<T> extends RecyclerView.Adapter<ViewHolder>{
    ...
    public BaseRecyclerPoAdapter(Context context, int layoutId, List<T> datas) {
        mContext = context;
        mLayoutId = layoutId;
        mDatas = datas;
